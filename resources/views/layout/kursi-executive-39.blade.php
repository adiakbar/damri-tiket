<div class="container-kursi" data-kode-trayek="{{ $bis->kode_trayek }}" data-nomor-bis="{{ $bis->nomor_bis }}" data-bis-id="{{ $bis->bis_id }}">
	...
	<div class="baris">
		...
		<div class="kursi space @if(isset($kursi[$bis->nomor_bis]['8B'])) {{ $kursi[$bis->nomor_bis]['8B'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['8B'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['8B'].' ('.$telephone[$bis->nomor_bis]['8B'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['8B'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['8B'] }}</p></div>" @endif>
	...
	<div class="baris">
		<div style="margin-left: 120px;" class="kursi @if(isset($kursi[$bis->nomor_bis]['9C'])) {{ $kursi[$bis->nomor_bis]['9C'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['9C'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['9C'].' ('.$telephone[$bis->nomor_bis]['9C'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['9C'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['9C'] }}</p></div>" @endif>
	...
	<div class="baris">
		<div class="kursi @if(isset($kursi[$bis->nomor_bis]['10A'])) {{ $kursi[$bis->nomor_bis]['10A'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['10A'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['10A'].' ('.$telephone[$bis->nomor_bis]['10A'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['10A'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['10A'] }}</p></div>" @endif>
			<input type="checkbox" value="10A" name="kursi[]" class="cek-kursi">10A
		</div>
		<div class="kursi @if(isset($kursi[$bis->nomor_bis]['10B'])) {{ $kursi[$bis->nomor_bis]['10B'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['10B'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['10B'].' ('.$telephone[$bis->nomor_bis]['10B'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['10B'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['10B'] }}</p></div>" @endif>
			<input type="checkbox" value="10B" name="kursi[]" class="cek-kursi">10B
		</div>
		<div class="kursi @if(isset($kursi[$bis->nomor_bis]['10C'])) {{ $kursi[$bis->nomor_bis]['10C'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['10C'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['10C'].' ('.$telephone[$bis->nomor_bis]['10C'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['10C'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['10C'] }}</p></div>" @endif>
			<input type="checkbox" value="10C" name="kursi[]" class="cek-kursi">10C
		</div>
		<div class="kursi @if(isset($kursi[$bis->nomor_bis]['10D'])) {{ $kursi[$bis->nomor_bis]['10D'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['10D'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['10D'].' ('.$telephone[$bis->nomor_bis]['10D'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['10D'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['10D'] }}</p></div>" @endif>
			<input type="checkbox" value="10D" name="kursi[]" class="cek-kursi">10D
		</div>
		<div class="kursi @if(isset($kursi[$bis->nomor_bis]['10E'])) {{ $kursi[$bis->nomor_bis]['10E'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['10E'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['10E'].' ('.$telephone[$bis->nomor_bis]['10E'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['10E'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['10E'] }}</p></div>" @endif>
			<input type="checkbox" value="10E" name="kursi[]" class="cek-kursi">10E
		</div>
	</div>
</div>