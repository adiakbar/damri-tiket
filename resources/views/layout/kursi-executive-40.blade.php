<div class="container-kursi" data-kode-trayek="{{ $bis->kode_trayek }}" data-nomor-bis="{{ $bis->nomor_bis }}" data-bis-id="{{ $bis->bis_id }}">
	...
	<div class="baris">
		...
		<div class="kursi space @if(isset($kursi[$bis->nomor_bis]['9B'])) {{ $kursi[$bis->nomor_bis]['9B'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['9B'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['9B'].' ('.$telephone[$bis->nomor_bis]['9B'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['9B'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['9B'] }}</p></div>" @endif>
	...
	<div class="baris">
		...
		<div style="margin-left: 40px;" class="kursi @if(isset($kursi[$bis->nomor_bis]['10A'])) {{ $kursi[$bis->nomor_bis]['10A'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['10A'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['10A'].' ('.$telephone[$bis->nomor_bis]['10A'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['10A'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['10A'] }}</p></div>" @endif>
	...
	<div class="baris">
		<div style="margin-left: 120px;" class="kursi @if(isset($kursi[$bis->nomor_bis]['11A'])) {{ $kursi[$bis->nomor_bis]['11A'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['11A'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['11A'].' ('.$telephone[$bis->nomor_bis]['11A'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['11A'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['11A'] }}</p></div>" @endif>
			<input type="checkbox" value="11A" name="kursi[]" class="cek-kursi">11A
		</div>
		<div class="kursi @if(isset($kursi[$bis->nomor_bis]['11B'])) {{ $kursi[$bis->nomor_bis]['11B'] }} @endif" @if(isset($penumpang[$bis->nomor_bis]['11B'])) data-toggle="tooltip" title="<div class='box-tooltip'><p>{{ $penumpang[$bis->nomor_bis]['11B'].' ('.$telephone[$bis->nomor_bis]['11B'].')' }}</p><p>Asal: {{ $asal[$bis->nomor_bis]['11B'] }}</p><p>Tujuan: {{ $tujuan[$bis->nomor_bis]['11B'] }}</p></div>" @endif>
			<input type="checkbox" value="11B" name="kursi[]" class="cek-kursi">11B
		</div>
	</div>
</div>