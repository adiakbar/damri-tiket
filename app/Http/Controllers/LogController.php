...
class LogController extends Controller
{
    ...
    public function logPetugasHarian(Request $request)
    {
        $data['menu'] = 'log';
        ...
        // return $tanggal;
        return view('log.log-petugas-harian', $data);
    }

    public function logPetugasHarianDetail(Request $request, $id)
    {
        $data['menu'] = 'log';
        ...
        return view('log.log-petugas-harian-detail', $data);
    }
}
